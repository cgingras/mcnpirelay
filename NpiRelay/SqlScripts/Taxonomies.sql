...
,('276400000XHospital Units/Rehabilitation/Substance Use Disorder Unit')
,('281P00000XHospitals/Chronic Disease Hospital')
,('281PC2000XHospitals/Chronic Disease Hospital/Children')
,('282NR1301XHospitals/General Acute Care Hospital/Rural')
,('282NW0100XHospitals/General Acute Care Hospital/Women')
...
,('315D00000XNursing & Custodial Care Facilities/Hospice, Inpatient')
,('315P00000XNursing & Custodial Care Facilities/Intermediate Care Facility, Mentally Retarded')
,('332800000XSuppliers/Indian Health Service/Tribal/Urban Indian Health (I/T/U) Pharmacy')
...
UPDATE Taxonomy SET
    [Description] = 'Behavioral Health & Social Service Providers/Psychologist, Intellectual & Developmental Disabilities'
WHERE [Code] = '103TM1800X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Anesthesiology, Addiction Medicine'
WHERE [Code] = '207L00000X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Orthopedic Surgery'
WHERE [Code] = '207X00000X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Orthopedic Surgery/Pediatric Orthopedic Surgery'
WHERE [Code] = '207XP3100X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Orthopedic Surgery/Hand Surgery'
WHERE [Code] = '207XS0106X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Orthopedic Surgery/Adult Reconstructive Orthopedic Surgery'
WHERE [Code] = '207XS0114X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Orthopedic Surgery/Orthopedic Surgery of the Spine'
WHERE [Code] = '207XS0117X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Orthopedic Surgery/Foot and Ankle Surgery'
WHERE [Code] = '207XX0004X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Orthopedic Surgery/Sports Medicine'
WHERE [Code] = '207XX0005X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Orthopedic Surgery/Orthopedic Trauma'
WHERE [Code] = '207XX0801X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/ Otolaryngology'
WHERE [Code] = '207Y00000X'
UPDATE Taxonomy SET
    [Description] = 'Allopathic & Osteopathic Physicians/Psychiatry '
WHERE [Code] = '2084P0800X'
UPDATE Taxonomy SET
    [Description] = 'Speech, Language and Hearing Service Providers'
WHERE [Code] = '235Z00000X'
UPDATE Taxonomy SET
    [Description] = 'Ambulatory Health Care Facilities/Clinic/Center, Multi-Specialty'
WHERE [Code] = '261Q00000X'
UPDATE Taxonomy SET
    [Description] = 'Ambulatory Health Care Facilities/Clinic/Center, Multi-Specialty'
WHERE [Code] = '261QM1300X'
UPDATE Taxonomy SET
    [Description] = 'Physician Assistants & Advanced Practice Nursing Providers/Nurse Anesthetist, Certified Registered'
WHERE [Code] = '367500000X'
